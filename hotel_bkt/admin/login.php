  ...
  <body>
      ...
      *********************************************************************************************************************************************************** -->
		      <form class="form-login" action="act/login.php" method="post">
		        <h2 class="form-login-heading" style="background:black;border-color:white">sign in now</h2>
                ...
                <div class="registration">
		            ...
		            <hr>
                <a href="../" class="btn btn-theme btn-block"style="background:black;border-color:white">Back</a>
		        </div>
