...
<head>
    ...
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA6Eo3raX1OXgNBYxnsxkrXbqlX6M0078g"></script>
      ...
      <header class="header black-bg">
        <div class="sidebar-toggle-box">
          <div class="fa fa-bars tooltips" data-placement="right" data-original-title="Toggle Navigation"></div>
            ...
            <!--logo start-->
        <a href="index.php" class="logo"><b>WebGIS Hotel (27-1811523010 Salma Hanifah)</b></a>
        <div class="top-menu">
                    ...
                    <div class="col-sm-12"> <!-- gallery -->
                      <section class="panel">
                          ...
                          <a class="btn btn-compose" style="background-color:black;border-bottom:1px solid black;color:white">Gallery</a>
                              ...
                              <div class="html5gallery" style="max-height:700px; display:block;" data-skin="horizontal" data-width="490" data-height="300" data-resizemode="fit"><?php
                              ...
                              if (strpos($id,"H") !== false) {  //Hotel
                                ...
                                while($baris = pg_fetch_assoc($hasil)){
                                  if(($baris['gallery_hotel']=='-')||($baris['gallery_hotel']=='')){
                                    echo "<a href='../_foto/foto.jpg'><img src='../_foto/foto.jpg' ><br></a>";
                                  }
                                  else{
                                    echo "<br><br><a href='../_foto/".$baris['gallery_hotel']."'><img src='../_foto/".$baris['gallery_hotel']."'></a>";
                                  }
                                }
